...
<html lang="en">
  <head>
    ...
    <!-- for each test, generate CSS/LESS link tags -->
      ...
      <link id="original-less:test-less-urls" title="test-less-urls" rel="stylesheet/less" type="text/css" href="../../test/browser/less/relative-urls/urls.less">
      <link id="expected-less:test-less-urls" rel="stylesheet" type="text/css" href="../../test/browser/css/relative-urls/urls.css">
    ...
    <!-- Helpers - The less options -->
        ...
        <script src="../../test/browser/runner-relative-urls-options.js"></script>
    ...
    <!-- Spec -->
        ...
        <script src="../../test/browser/runner-relative-urls-spec.js"></script>
