...
<html lang="en">
  <head>
    ...
    <!-- for each test, generate CSS/LESS link tags -->
      ...
      <link id="original-less:test-less-urls" title="test-less-urls" rel="stylesheet/less" type="text/css" href="../../test/browser/less/rootpath-relative/urls.less">
      <link id="expected-less:test-less-urls" rel="stylesheet" type="text/css" href="../../test/browser/css/rootpath-relative/urls.css">
    ...
    <!-- Helpers - The less options -->
        ...
        <script src="../../test/browser/runner-rootpath-relative-options.js"></script>
    ...
    <!-- Spec -->
        ...
        <script src="../../test/browser/runner-rootpath-relative-spec.js"></script>
