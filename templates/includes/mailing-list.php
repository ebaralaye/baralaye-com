  ...
  <div class="inner">
    <div id="mc_embed_signup">
      <form class="form-container form-row" action="http://baralaye.us3.list-manage.com/subscribe/post?u=0497c3e7f0db060ff7eae50ba&amp;id=7522fe55b6" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
        <div class="row">
          <div class="form-group mc-field-group col-xs-8 col-sm-8">
            <label for="mce-EMAIL">Email Address  <span class="asterisk">*</span></label>
            <input name="EMAIL" id="mce-EMAIL" class="form-control required" type="email" value="" placeholder="Email / Mailing List">
          </div>
          <!--<div class="form-group mc-field-group col-xs-6 col-md-3">
          ...
          <div class="form-foot col-xs-4 col-sm-4">
            <input type="submit" value="Join" name="subscribe" id="mc-embedded-subscribe" class="btn submit f-l">
          </div>
        </div>
    ...
    <script type="text/javascript" src="/libs/vendor/mailchimp/js/mailing-list.js"></script>
  </div>
</section>
