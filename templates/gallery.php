    ...
    <li>
      ...
      <div class="images ltbx">
        ...
        <?php foreach($slides as $slide): ?>
          <a href="<?php echo $gallery_dirs['large']; ?><?php echo $item['id']; ?>_<?php echo $slide ?>.jpg" 
            <?php if (array_search($slide, $slides)==0): ?>class="main"<?php endif; ?> 
            rel="<?php echo $item['id']; ?>" 
            title="<?php echo $item['name']; ?>">
            <img alt="<?php echo $item['name']; ?>" src="<?php echo $gallery_dirs['small']; ?><?php echo $item['id']; ?>_<?php echo $slide ?>.jpg" />
          </a>
        <?php endforeach; ?>
      </div>
    </li>
