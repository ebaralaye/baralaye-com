<div class="page-body connect">
    ...
    <div class="section contact">
        ...
        <p>
        <a href="mailto:ebi@baralaye.com">ebi@baralaye.com</a> | (646) 301-6311
        <br />
        <a href="http://efanyc.org" target="_blank">The Elizabeth Foundation for the Arts</a>
        <br />
...
<div class="section mailing-list">
    ...
    <form class="mailing-list" name="catwebformform58622" method="post" onsubmit="return checkWholeForm58622(this)" enctype="multipart/form-data" action="/FormProcessv2.aspx?WebFormID=23446&amp;OID={module_oid}&amp;OTYPE={module_otype}&amp;EID={module_eid}&amp;CID={module_cid}&amp;OPTIN=true">
        <ul class="field-list s70">
            <li class="s1of2">
            <label for="FullName">Name</label>
            ...
            <li class="s1of2">
            <label>&nbsp;</label>
            <input class="btn submit f-r" name="catwebformbutton" type="submit" value="Subscribe" />
            <span class="d-n">
                <input name="CampaignList_44479" type="checkbox" checked="checked" value="on" />
        ...
        <script type="text/javascript">
            //<![CDATA[
        var submitcount58622 = 0;
        function checkWholeForm58622(theForm) {
            var why = "";
            if(theForm.FirstName)
                why += isEmpty(theForm.FirstName.value, "First Name");
            if(theForm.LastName)
...
<ul id="set_72157628627505367" class="productSmall photoset"></ul>
<div class="hr"></div>
...
<div class="hr"></div>
<h1 id="artists">Artists &amp; Friends</h1>
...
<!--<h1 id="media"><a href="/resources">Links &amp; Resources</a></h1>-->
</div>
